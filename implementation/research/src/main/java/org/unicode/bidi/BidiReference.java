...
public final class BidiReference {
    ...
    public final static byte implicitEmbeddingLevel = 2; // level will be determined implicitly
    private byte paragraphEmbeddingLevel = implicitEmbeddingLevel; 
    ...
    public byte [] getResultTypes() { return resultTypes.clone(); } // for display in test mode
     ...
     */
    private final byte[] pairTypes; // paired Bracket types for paragraph
    private final int[] pairValues; // paired Bracket values for paragraph
    ...
    /**
     * @return  Return the base level of the paragraph.
     */
    ...
    /**
     * @param biditype
     * @return Return true if the type is one of the types removed in X9.
     ...
     * @return
     */
    public static final BidiReference analyzeInput(byte[] types, byte [] pairTypes, int [] pairValues, byte paragraphEmbeddingLevel) {
