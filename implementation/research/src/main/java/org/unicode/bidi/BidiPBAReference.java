...
public class BidiPBAReference {
	...
	private SortedSet<BracketPair> pairPositions;
	
	public String getPairPositionsString()
	{
		SortedSet<BracketPair> tempPositions = new TreeSet<BracketPair>();
		for (BracketPair pair : pairPositions) {
			tempPositions.add(new BracketPair(indexes[pair.getOpener()], indexes[pair.getCloser()]));
		}
