...
public abstract class OtpGenServer extends OtpSysProcess {
     ...
     * with timeout = 5000
     *
     * @param host   This node
     * @param server gen_server PID
     * @param call   message to send
     * @return the response from the server or null if timeout was met
     * @throws OtpErlangException If the response from the server is invalid
     */
     ...
     * @param server  gen_server PID
     * @param call    message to send
     * @param timeout Timeout is a long which specifies how many milliseconds to
     ...
     *
     * @param host   This node
     * @param server gen_server registered name
     * @param node   node where the gen_server lives
     * @param call   message to send
     * @return the response from the server or null if timeout was met
     * @throws OtpErlangException If the response from the server is invalid
     */
     ...
     * @param node    node where the gen_server lives
     * @param call    message to send
     * @param timeout Timeout is an long which specifies how many milliseconds to
     *                wait for a reply, or 0 to wait indefinitely. If no reply is
     *                received within the specified time, the function call returns
     *                null.
     * @return the response from the server or null if timeout was met
     ...
     * @param reply The response to be sent
     */
